...
(function (global, factory) {
            ...
            Url.prototype = { set: set$1, toString: toString$1 };
            ...
            function parseVideo(video) {
                ...
                config.config = Object.assign(
                    config.config,
                    new urlParse(config.url, true).query
                );
            ...
            function getVideoId(url){
                var parts = url.replace(/(>|<)/gi,'').split(/(vi\/|v=|\/v\/|youtu\.be\/|\/embed\/)/);
            ...
            var VideoItem = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('iframe',{staticClass:"ytpl-iframe",attrs:{"id":("yt-" + (_vm.video.id)),"src":_vm.url,"type":"text/html","width":_vm.width,"height":_vm.height,"frameborder":"0"}})},staticRenderFns: [],
                name: 'Video',
                ...
                computed: {
                    url: function url() {
                        var url = new urlParse(this.video.url, true);
            ...
            var ThumbnailItem = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('button',{ref:"button",staticClass:"ytpl-thumbnail",class:{'ytpl-active' : _vm.video.active},style:(("width: " + (_vm.width) + "px; height: " + (_vm.height) + "px; background-image: url('" + (_vm.video.thumbnail) + "')")),attrs:{"title":"Click to watch","type":"button"},on:{"click":_vm.watchVideo}},[_c('div',{staticClass:"ytpl-thumbnail-overlay"},[_c('svg',{attrs:{"viewBox":"0 0 90 90","xmlns":"http://www.w3.org/2000/svg"}},[_c('path',{attrs:{"d":"M45 0C20.1 0 0 20.1 0 45s20.1 45 45 45 45-20.1 45-45S69.9 0 45 0zm24 46L30.8 70.5c-.8-.5-1-.5-1.8-1v-49c.8-.5 1-.5 1.8-1L69 44v2z","fill":_vm.btnColour,"fill-rule":"nonzero"}})])])])},staticRenderFns: [],
                ...
                mounted: function mounted() {
                    ...
                    this.$nextTick(function () {
                        window.onload = this$1.resizeThumbnail();
                        window.onresize = debounce(function () { return this$1.resizeThumbnail(); }, 10);
                    });
                },

                methods: {

                    resizeThumbnail: function resizeThumbnail() {
                        var ref = this.aspectRatio.split(':');
                        var numerator = ref[0];
                        var denominator = ref[1];
            ...
            var wheel = function(i) {
              ...
              function shouldBeConsumedByChild(target, deltaX, deltaY) {
                ...
                if (!env$1.isWebKit && element.querySelector('select:focus')) {
                  return true;
                }
            ...
            var YoutubePlaylist = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"ytpl-container"},[(_vm.playlist.length > 1)?_c('div',{ref:"scrollarea",staticClass:"ytpl-playlist",style:(("height: " + (_vm.playlistHeight) + ";"))},[_c('div',{staticClass:"ytpl-scrollable-content",style:(("width: " + (_vm.playlistWidth)))},_vm._l((_vm.playlist),function(video){return _c('thumbnail-item',{key:video.id,attrs:{"video":video,"aspect-ratio":_vm.aspectRatio,"btn-colour":_vm.btnColour}})}))]):_vm._e(),_vm._v(" "),_c('div',{ref:"player",staticClass:"ytpl-player"},[(_vm.active)?_c('video-item',{attrs:{"video":_vm.active,"width":_vm.width,"height":_vm.height}}):_vm._e()],1)])},staticRenderFns: [],
                ...
                beforeMount: function beforeMount() {
                    ...
                    this.videos.forEach(function (video) {
                        this$1.playlist.push(
                            parseVideo(video)
                        );
                    });

                    (assign = this.aspectRatio.split(':'), this.width = assign[0], this.height = assign[1]);
                },
                ...
                mounted: function mounted() {
                    ...
                    this.$nextTick(function () {
                        window.onload = this$1.resizeVideo();
                        window.onresize = debounce(function () { return this$1.resizeVideo(); }, 70);
                    });
                    ...
                    setInterval(function () { return this$1.scrollbar.update(); }, 10000);
                },
                ...
                computed: {
                    ...
                    active: function active() {
                        return this.playlist.find(function (video) { return video.active; });
                    },

                    playlistHeight: function playlistHeight() {
                    ...
                    playlistWidth: function playlistWidth() {
                        if (this.windowWidth > 620) {
                            return '100%';
                        }
            ...
            var Example = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"app"},[_c('youtube-playlist',{attrs:{"aspect-ratio":"640:360","videos":_vm.videos}})],1)},staticRenderFns: [],
                name: 'app',
                components: {YoutubePlaylist: YoutubePlaylist},
                data: function data() {
                    return {
                        videos: [
            ...
            var app = new Vue({
              render: function (h) { return h(Example); }
            }).$mount('#app');
